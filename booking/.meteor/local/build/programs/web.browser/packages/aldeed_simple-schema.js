...
SimpleSchema.prototype.objectKeys = function(keyPrefix) {                                                              // 1142
  ...
  return self._objectKeys[keyPrefix + "."] || [];                                                                      // 1147
                                                                                                                       ...
                                                                                                                       // 1149
SimpleSchema.prototype.validate = function (obj, options) {                                                            // 1150
  if (Package['check'] && Package['audit-argument-checks']) {                                                          // 1151
    // Call check but ignore the error to silence audit-argument-checks                                                // 1152
    try { check(obj) } catch (e) { /* ignore error */ }                                                                // 1153
  }                                                                                                                    // 1154
                                                                                                                       // 1155
  var validationContext = this.newContext();                                                                           // 1156
  var isValid = validationContext.validate(obj, options);                                                              // 1157
                                                                                                                       // 1158
  if (isValid) return;                                                                                                 // 1159
                                                                                                                       // 1160
  var errors = validationContext.invalidKeys().map(function (error) {                                                  // 1161
    return {                                                                                                           // 1162
      name: error.name,                                                                                                // 1163
      type: error.type,                                                                                                // 1164
      details: {                                                                                                       // 1165
        value: error.value                                                                                             // 1166
      }                                                                                                                // 1167
    };                                                                                                                 // 1168
  });                                                                                                                  // 1169
                                                                                                                       // 1170
  throw new Package['mdg:validation-error'].ValidationError(errors);                                                   // 1171
};                                                                                                                     // 1172
                                                                                                                       // 1173
SimpleSchema.prototype.validator = function (options) {                                                                // 1174
  var self = this;                                                                                                     // 1175
  options = options || {};                                                                                             // 1176
  return function (obj) {                                                                                              // 1177
    if (options.clean === true) self.clean(obj, options);                                                              // 1178
    self.validate(obj);                                                                                                // 1179
  };                                                                                                                   // 1180
};                                                                                                                     // 1181
                                                                                                                       // 1182
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
